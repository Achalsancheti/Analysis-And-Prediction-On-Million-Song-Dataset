...
public class HottestSongMapReduece {
	public static class HSMapper
	extends Mapper<LongWritable, Text, FloatWritable, Text>{
		...
		public void map(LongWritable key, Text value, Context context
			...
			if(songId.indexOf("SO")!=-1){
				try{
					float k=Float.parseFloat(words[18].trim());
					if(k>0){
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(HottestSongMapReduece.class);
